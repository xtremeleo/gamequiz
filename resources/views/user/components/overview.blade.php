...
<div class="main-color-2-bg">
	<div class="container">	
		<div class="row pt-2">
			<div class="col-lg-4 col-md-4 col-sm-12  {{ ($view == 'wallet' ? '' : '  d-none d-sm-none d-md-block') }}">
				<p class="black"><i class="bi bi-wallet2"></i> Wallet</p>
				<h3 class="black pb-2">₦{{walletBalance()}}</h3>
		...
		<div class="row p-0">
			<div class="col-lg-4 col-md-4 col-sm-12 {{ ($view == 'wallet' ? '' : ' d-none d-sm-none d-md-block') }}">
				<div class="row p-0 ">
					<ul class="nav justify-content-between">
						<li class="nav-item">
							<a class="nav-link black" href="{{route('account.bank')}}"><i class="bi bi-bank2"></i><span class="d-inline d-md-none d-lg-inline"> Bank Accounts</span></a>
						</li>
						<li class="nav-item">
			...
			<div class="col-lg-4 col-md-4 col-sm-12  {{ ($view == 'quiz' ? '' : ' d-none d-sm-none d-md-block') }}">
				<div class="row p-0 ">
					<ul class="nav justify-content-between">
					 <li class="nav-item">
						<a class="nav-link black" href="{{route('game')}}"><i class="bi bi-hourglass-top"></i><span class="d-inline d-md-none d-lg-inline"> Current</span></a>
					  </li>
					  <li class="nav-item">
						<a class="nav-link black" href="{{route('game.past')}}"><i class="bi bi-hourglass-bottom"></i><span class="d-inline d-md-none d-lg-inline"> Past</span></a>
					  </li>
					</ul>
				</div>
			</div>
